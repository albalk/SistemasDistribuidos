    ...
    public:
        ...
        void readFile(char* fileName, char* &data, unsigned long int &dataLength){
            ...
            if(ok!=MSG_OK){
                ...
                dataLength = unpack<unsigned long int>(rpcIn); //desempaqueta el tamaño
                data = new char[dataLength]; //reserva de memoria
                unpackv(rpcIn, (char*)data, dataLength); //desempaqueta el dato
            }
        }
